    ...
    >
      ...
      >
        ...
        >
          <Icon
            ...
            type="favorite"
            fontSize="24px"
            {...getOverrideProps(overrides, "Iconeij")}
          ></Icon>
          <Text
            fontFamily="Inter"
            fontSize="14px"
      ...
      >
        ...
        >
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frameugz")}
          >
            <Flex
              gap="16px"
              direction="row"
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Frameamj")}
            >
              <Text
                fontFamily="Inter"
                fontSize="16px"
            ...
            <Flex
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Frametnc")}
            >
              <Icon
                width="24px"
                height="24px"
                ...
                type="more_horiz"
                fontSize="24px"
                {...getOverrideProps(overrides, "Iconyjt")}
              ></Icon>
            </Flex>
          </Flex>
          <Text
      ...
      >
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Sharedrj")}
        >
          <Icon
            width="24px"
            height="24px"
            ...
            type="reply"
            fontSize="24px"
            {...getOverrideProps(overrides, "Iconyoi")}
          ></Icon>
          <Text
            fontFamily="Inter"
            fontSize="16px"
            ...
            whiteSpace="pre-wrap"
            children="99"
            {...getOverrideProps(overrides, "99gzr")}
          ></Text>
        </Flex>
        <Flex
          gap="16px"
        ...
        >
          <Icon
            ...
            type="shuffle"
            fontSize="24px"
            {...getOverrideProps(overrides, "Iconmpb")}
          ></Icon>
          <Text
            fontFamily="Inter"
            fontSize="16px"
            ...
            whiteSpace="pre-wrap"
            children="99"
            {...getOverrideProps(overrides, "99fkq")}
          ></Text>
        </Flex>
        <Flex
          gap="16px"
        ...
        >
          <Icon
            ...
            fontSize="24px"
            {...getOverrideProps(overrides, "Iconznu")}
          ></Icon>
          <Text
            fontFamily="Inter"
            fontSize="16px"
            ...
            whiteSpace="pre-wrap"
            children="99"
            {...getOverrideProps(overrides, "99oev")}
          ></Text>
        </Flex>
        <Icon
          width="24px"
          ...
          type="share"
          fontSize="24px"
          {...getOverrideProps(overrides, "Iconojk")}
        ></Icon>
      </Flex>
    </Flex>
  );
