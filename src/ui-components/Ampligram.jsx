  ...
  return (
    ...
    >
      <Divider
        ...
        {...getOverrideProps(overrides, "Dividerits")}
      ></Divider>
      <Flex
        gap="16px"
        direction="row"
      ...
      >
        ...
        >
          <Image
            ...
            borderRadius="160px"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "imagelav")}
          ></Image>
          <Text
            fontFamily="Inter"
            fontSize="16px"
        ...
        >
          <Icon
            ...
            type="more_vert"
            fontSize="24px"
            {...getOverrideProps(overrides, "Iconooj")}
          ></Icon>
        </Flex>
      </Flex>
      <Image
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "imagexbv")}
      ></Image>
      <Flex
        gap="16px"
        direction="row"
      ...
      >
        ...
        >
          <Icon
            ...
            fontSize="24px"
            {...getOverrideProps(overrides, "Iconsmn")}
          ></Icon>
          <Icon
            width="24px"
            height="24px"
            ...
            fontSize="24px"
            {...getOverrideProps(overrides, "Iconflq")}
          ></Icon>
          <Icon
            width="24px"
            height="24px"
            ...
            type="send"
            fontSize="24px"
            {...getOverrideProps(overrides, "Iconydg")}
          ></Icon>
        </Flex>
        <Flex
          gap="10px"
        ...
        >
          <Icon
            ...
            fontSize="24px"
            {...getOverrideProps(overrides, "Iconpzj")}
          ></Icon>
        </Flex>
      </Flex>
      <Flex
      ...
      >
        <Divider
          ...
          size="small"
          orientation="horizontal"
          {...getOverrideProps(overrides, "Dividerrfq")}
        ></Divider>
        <Flex
          gap="8px"
          direction="column"
