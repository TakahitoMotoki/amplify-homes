  ...
  return (
    ...
    >
      <Divider
        ...
        {...getOverrideProps(overrides, "Dividerhqd")}
      ></Divider>
      <Flex
        gap="16px"
        direction="row"
      ...
      >
        ...
        >
          <Image
            ...
            borderRadius="160px"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "imagezff")}
          ></Image>
          <Text
            fontFamily="Inter"
            fontSize="16px"
        ...
        >
          <Icon
            ...
            type="more_vert"
            fontSize="24px"
            {...getOverrideProps(overrides, "Iconwug")}
          ></Icon>
        </Flex>
      </Flex>
      <Image
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "imagegzj")}
      ></Image>
      <Flex
        gap="16px"
        direction="row"
      ...
      >
        ...
        >
          <Icon
            ...
            fontSize="24px"
            {...getOverrideProps(overrides, "Iconlgt")}
          ></Icon>
          <Icon
            width="24px"
            height="24px"
            ...
            fontSize="24px"
            {...getOverrideProps(overrides, "Iconawm")}
          ></Icon>
          <Icon
            width="24px"
            height="24px"
            ...
            type="send"
            fontSize="24px"
            {...getOverrideProps(overrides, "Iconleu")}
          ></Icon>
        </Flex>
        <Flex
          gap="10px"
        ...
        >
          <Icon
            ...
            fontSize="24px"
            {...getOverrideProps(overrides, "Iconlqe")}
          ></Icon>
        </Flex>
      </Flex>
      <Flex
      ...
      >
        <Divider
          ...
          size="small"
          orientation="horizontal"
          {...getOverrideProps(overrides, "Dividermbe")}
        ></Divider>
        <Flex
          gap="8px"
          direction="column"
