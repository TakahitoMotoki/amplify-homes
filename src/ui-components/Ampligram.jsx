  ...
  return (
    ...
    >
      <Divider
        ...
        {...getOverrideProps(overrides, "Divideroim")}
      ></Divider>
      <Flex
        gap="16px"
        direction="row"
      ...
      >
        ...
        >
          <Image
            ...
            borderRadius="160px"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "imagegbe")}
          ></Image>
          <Text
            fontFamily="Inter"
            fontSize="16px"
        ...
        >
          <Icon
            ...
            type="more_vert"
            fontSize="24px"
            {...getOverrideProps(overrides, "Iconsxl")}
          ></Icon>
        </Flex>
      </Flex>
      <Image
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "imagebmd")}
      ></Image>
      <Flex
        gap="16px"
        direction="row"
      ...
      >
        ...
        >
          <Icon
            ...
            fontSize="24px"
            {...getOverrideProps(overrides, "Iconrcj")}
          ></Icon>
          <Icon
            width="24px"
            height="24px"
            ...
            fontSize="24px"
            {...getOverrideProps(overrides, "Iconxti")}
          ></Icon>
          <Icon
            width="24px"
            height="24px"
            ...
            type="send"
            fontSize="24px"
            {...getOverrideProps(overrides, "Iconrqd")}
          ></Icon>
        </Flex>
        <Flex
          gap="10px"
        ...
        >
          <Icon
            ...
            fontSize="24px"
            {...getOverrideProps(overrides, "Iconezz")}
          ></Icon>
        </Flex>
      </Flex>
      <Flex
      ...
      >
        <Divider
          ...
          size="small"
          orientation="horizontal"
          {...getOverrideProps(overrides, "Dividerlug")}
        ></Divider>
        <Flex
          gap="8px"
          direction="column"
