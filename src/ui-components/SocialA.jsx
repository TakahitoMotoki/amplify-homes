  ...
  return (
    ...
    >
        ...
        >
          ...
          >
            <Icon
              ...
              type="arrow_forward"
              fontSize="24px"
              {...getOverrideProps(overrides, "Iconkjk")}
            ></Icon>
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Sharedze")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
              ...
              whiteSpace="pre-wrap"
              children="Share"
              {...getOverrideProps(overrides, "Sharekzo")}
            ></Text>
            <Icon
              width="24px"
              height="24px"
              ...
              fontSize="24px"
              {...getOverrideProps(overrides, "Iconsls")}
            ></Icon>
            <Icon
              width="24px"
              height="24px"
              ...
              type="share"
              fontSize="24px"
              {...getOverrideProps(overrides, "Iconqnv")}
            ></Icon>
            <Icon
              width="24px"
              height="24px"
              ...
              type="more_vert"
              fontSize="24px"
              {...getOverrideProps(overrides, "Iconvdf")}
            ></Icon>
          </Flex>
        </Flex>
        <Image
      ...
      <Flex
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Read moredfu")}
      >
        <Icon
          width="24px"
          height="24px"
          ...
          type="arrow_forward"
          fontSize="24px"
          {...getOverrideProps(overrides, "Iconmbp")}
        ></Icon>
        <Text
          fontFamily="Inter"
          fontSize="16px"
          ...
          whiteSpace="pre-wrap"
          children="Read more"
          {...getOverrideProps(overrides, "Read moreaei")}
        ></Text>
      </Flex>
    </Flex>
  );
