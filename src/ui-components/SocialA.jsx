    ...
    >
        ...
        >
          ...
          >
            <Icon
              ...
              type="arrow_forward"
              fontSize="24px"
              {...getOverrideProps(overrides, "Iconwvj")}
            ></Icon>
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          >
            <Text
              ...
              whiteSpace="pre-wrap"
              children="Share"
              {...getOverrideProps(overrides, "Sharevrj")}
            ></Text>
            <Icon
              width="24px"
              height="24px"
              ...
              fontSize="24px"
              {...getOverrideProps(overrides, "Iconuyx")}
            ></Icon>
            <Icon
              width="24px"
              height="24px"
              ...
              type="share"
              fontSize="24px"
              {...getOverrideProps(overrides, "Icongrx")}
            ></Icon>
            <Icon
              width="24px"
              height="24px"
              ...
              type="more_vert"
              fontSize="24px"
              {...getOverrideProps(overrides, "Iconlkt")}
            ></Icon>
          </Flex>
        </Flex>
        <Image
      ...
      >
        <Icon
          ...
          type="arrow_forward"
          fontSize="24px"
          {...getOverrideProps(overrides, "Icontoi")}
        ></Icon>
        <Text
          fontFamily="Inter"
          fontSize="16px"
          ...
          whiteSpace="pre-wrap"
          children="Read more"
          {...getOverrideProps(overrides, "Read moregzd")}
        ></Text>
      </Flex>
    </Flex>
  );
