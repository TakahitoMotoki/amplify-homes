      ...
      >
        ...
        >
          <Badge
            ...
            size="small"
            variation="default"
            {...getOverrideProps(overrides, "Badgeojb")}
          ></Badge>
          <Badge
            display="flex"
            gap="10px"
            ...
            size="small"
            variation="default"
            {...getOverrideProps(overrides, "Badgemrv")}
          ></Badge>
          <Badge
            display="flex"
            gap="10px"
            ...
            size="small"
            variation="default"
            {...getOverrideProps(overrides, "Badgeaky")}
          ></Badge>
        </Flex>
        <Text
          fontFamily="Inter"
        ...
        >
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Featureiux")}
          >
            <Icon
              width="24px"
              height="24px"
              ...
              type="check"
              fontSize="24px"
              {...getOverrideProps(overrides, "Iconkjf")}
            ></Icon>
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Featurezoi")}
          >
            <Icon
              width="24px"
              height="24px"
              ...
              type="check"
              fontSize="24px"
              {...getOverrideProps(overrides, "Iconsuf")}
            ></Icon>
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Featureoxg")}
          >
            <Icon
              width="24px"
              height="24px"
              ...
              type="check"
              fontSize="24px"
              {...getOverrideProps(overrides, "Iconcar")}
            ></Icon>
            <Text
              fontFamily="Inter"
              fontSize="16px"
