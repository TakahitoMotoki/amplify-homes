      ...
      >
        ...
        >
          <Badge
            ...
            size="small"
            variation="default"
            {...getOverrideProps(overrides, "Badgewvj")}
          ></Badge>
          <Badge
            padding="4px 8px 4px 8px"
            display="flex"
            ...
            size="small"
            variation="default"
            {...getOverrideProps(overrides, "Badgeava")}
          ></Badge>
          <Badge
            padding="4px 8px 4px 8px"
            display="flex"
            ...
            size="small"
            variation="default"
            {...getOverrideProps(overrides, "Badgeiss")}
          ></Badge>
        </Flex>
        <Text
          fontFamily="Inter"
        ...
        >
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Featurekvn")}
          >
            <Icon
              width="24px"
              height="24px"
              ...
              type="check"
              fontSize="24px"
              {...getOverrideProps(overrides, "Iconthc")}
            ></Icon>
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Featureyxh")}
          >
            <Icon
              width="24px"
              height="24px"
              ...
              type="check"
              fontSize="24px"
              {...getOverrideProps(overrides, "Iconhtj")}
            ></Icon>
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Featuretsb")}
          >
            <Icon
              width="24px"
              height="24px"
              ...
              type="check"
              fontSize="24px"
              {...getOverrideProps(overrides, "Iconelb")}
            ></Icon>
            <Text
              fontFamily="Inter"
              fontSize="16px"
